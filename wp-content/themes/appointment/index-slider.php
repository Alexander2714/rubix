		...
		<div class="item active">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide1.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Comienza Ahora','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('Ejecute el proceso de facturación electrónica obligaria de manera rápida y eficiente.','appointment'); ?></span></div>	
				<div class="slide-btn-area-sm"><a href="https://localhost/Rubix/wp-content/plugins/rubix/registros.php" class="slide-btn-sm"><?php _e('Comienza Ahora','appointment'); ?></a></div>
			</div>
		</div>  
		<div class="item">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide3.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Facturación Electrónica','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('El Ministerio de Hacienda cambia! nosotros te ofrecemos la herramienta que hara fácil tu experiencia en la nueva Facturacion Electrónica','appointment'); ?></span></div>	
				<div class="slide-btn-area-sm"><a href="https://tribunet.hacienda.go.cr/principal.html" class="slide-btn-sm"><?php _e('Read More','appointment'); ?></a></div>		
			</div>
		</div>
		<div class="item">
		  <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide2.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Disfruta de la mejor experiencia','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('Puedes utilizarla en dispositivos mobiles y de escritorio','appointment'); ?></span></div>	
